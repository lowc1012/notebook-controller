...
import (
	...
	notebookcontrollerv1alpha1 "github.com/lowc1012/notebook-controller/pkg/apis/notebookcontroller/v1alpha1"
	versioned "github.com/lowc1012/notebook-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/lowc1012/notebook-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/lowc1012/notebook-controller/pkg/generated/listers/notebookcontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NotebookcontrollerV1alpha1().Notebooks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NotebookcontrollerV1alpha1().Notebooks(namespace).Watch(context.TODO(), options)
			},
		},
		&notebookcontrollerv1alpha1.Notebook{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *notebookInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&notebookcontrollerv1alpha1.Notebook{}, f.defaultInformer)
}
